...
export function useLocaleActions(): Pick<LocaleContextValue, 'setLocale'> { return useContext(LocaleContext); }
...
html.rtl .hero-copy-block{order:1}html.rtl .hero-visual{order:2}html.rtl .hero-location{left:auto;right:24px}html.rtl .hero-floating-card{right:auto;left:24px}
...
html.rtl .stats div{border-right:0;border-left:1px solid var(--line)}html.rtl .stats div:last-child{border-left:0}html.rtl .facts div{padding:20px 0 20px 16px}
`;
