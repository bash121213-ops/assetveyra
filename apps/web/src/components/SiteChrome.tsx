  ...
  return <>
    <header className="av-final-header">
      ...
      <details className="av-menu">
        ...
        <nav className="av-menu-panel" aria-label="Primary navigation">
          ...
          <details><summary><I18nText id="Policies"/></summary><a href="/terms"><I18nText id="Terms & Conditions"/></a><a href="/privacy"><I18nText id="Privacy Policy"/></a><a href="/policies"><I18nText id="Conflicts of Interest"/></a><a href="/policies#complaints"><I18nText id="Complaints"/></a><span className="av-menu-disabled"><I18nText id="AML/KYC"/> — <I18nText id="Draft"/></span></details>
    ...
    <footer className="av-site-footer">
      <div className="av-footer-grid">
        ...
        <div><h3><I18nText id="Policies"/></h3><a href="/terms"><I18nText id="Terms & Conditions"/></a><a href="/privacy"><I18nText id="Privacy Policy"/></a><a href="/policies#conflicts"><I18nText id="Conflicts of Interest"/></a><a href="/policies#complaints"><I18nText id="Complaints"/></a><span className="av-footer-disabled"><I18nText id="AML/KYC"/> — <I18nText id="Draft"/></span></div>
