...
const opportunities = [
  ['🇪🇸','Spain','$12,000,000','Luxury Villa / Palace','1,200 sqm','Europe','Verified','verified'],
  ['🇦🇪','United Arab Emirates','$25,000,000','Luxury Development','15,000 sqm','Middle East','Verified','verified'],
  ['🇨🇳','China','$18,000,000','Luxury Hospitality','5,500 sqm','Asia','Verified','verified'],
  ['🇺🇸','United States','$32,000,000','Luxury Villa Estate','2,800 sqm','Americas','Confidential','confidential'],
  ['🇦🇺','Australia','$14,500,000','Luxury Coastal Villas','3,100 sqm','Australia','Pending','pending'],
  ['🇫🇷','France','$21,000,000','Historic Luxury Estate','2,450 sqm','Europe','Confidential','confidential'],
] as const;
