...
const entries: Record<string, Record<Locale, string>> = {
  ...
  'Remove': { en: 'Remove', ar: 'إزالة', zh: '移除', es: 'Quitar', fr: 'Supprimer' },
  '20 images maximum.': { en: '20 images maximum.', ar: 'الحد الأقصى 20 صورة.', zh: '最多 20 张图片。', es: 'Máximo 20 imágenes.', fr: '20 images maximum.' },
  'This image could not be prepared.': { en: 'This image could not be prepared.', ar: 'تعذر تجهيز هذه الصورة.', zh: '无法处理此图片。', es: 'No se pudo preparar esta imagen.', fr: 'Cette image n’a pas pu être préparée.' },
  'Error': { en: 'Error', ar: 'خطأ', zh: '错误', es: 'Error', fr: 'Erreur' },
  'Remove this image?': { en: 'Remove this image?', ar: 'هل تريد إزالة هذه الصورة؟', zh: '要移除这张图片吗？', es: '¿Quitar esta imagen?', fr: 'Supprimer cette image ?' },
  'Some images could not be uploaded. You can add them later from the asset page.': { en: 'Some images could not be uploaded. You can add them later from the asset page.', ar: 'تعذر رفع بعض الصور. يمكنك إضافتها لاحقًا من صفحة الأصل.', zh: '部分图片未能上传。你可以稍后从资产页面添加。', es: 'Algunas imágenes no se pudieron subir. Puede añadirlas más tarde desde la página del activo.', fr: 'Certaines images n’ont pas pu être téléversées. Vous pourrez les ajouter plus tard depuis la page du bien.' },
