...
export type Locale = 'en' | 'ar' | 'zh' | 'es' | 'fr' | 'de' | 'ja' | 'ko';
...
'Legal Information':{en:'Legal Information',ar:'المعلومات القانونية',zh:'法律信息',es:'Información legal',fr:'Informations légales',de:'Rechtliche Informationen',ja:'法적情報',ko:'법률 정보'},
